...
public class ProductController {
    ...
    public ResponseEntity<Product> updateProduct(@RequestBody Product updatedProduct, @PathVariable Integer productId) {
        Product updatedProductResult = productService.updateProduct(updatedProduct, productId);
