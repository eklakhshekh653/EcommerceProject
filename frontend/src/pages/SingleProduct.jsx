...
const SingleProduct = () => {
  ...
  <div className="product_details">
    ...
    <p>Discount: {product.discount ? `${product.discount}% off` : "No discount available"}</p>
    <p>Payment Options: <b>Only Card</b></p>
...
<div className="counter-box">
  <h3>Quick Actions</h3>
  <div>
    <button onClick={() => navigate("/user/cart")}>Move To Cart</button>
  </div>
</div>
